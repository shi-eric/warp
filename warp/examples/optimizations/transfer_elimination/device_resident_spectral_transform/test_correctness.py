...
"""Check the device-resident spectral transform card."""
...
from warp.examples.optimizations.transfer_elimination.device_resident_spectral_transform.benchmark import (
    build_case,
)
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--iterations", action="append", required=True, type=int)
...
def main(argv: Sequence[str] | None = None) -> int:
    """Run the deterministic spectral-filter equivalence check."""
    ...
    for iterations in arguments.iterations:
        ...
        print(
            f"size={arguments.size} batch={arguments.batch} iterations={iterations}: "
